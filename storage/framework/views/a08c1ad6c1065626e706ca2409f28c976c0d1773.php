    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
              ...
              <?php if(Auth::user()->user_type == 'Customer'): ?>
                ...
                <li class = "<?php echo e(Request:: is('invoice-list') ? 'active' : ''); ?>">
                    <a href="/invoice-list">
                ...
                <li class = "<?php echo e(Request:: is('order-history') ? 'active' : ''); ?>">
                ...
                <li class = "<?php echo e(Request:: is('update-invoice') ? 'active' : ''); ?>">
