                        ...
                        <div class="card card-user">
                            ...
                            <div class="content">
                                <div class="author">
                                  ...
                                  <h4 class="title"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?><br />
                                     <a href="#"><small><?php echo e(Auth::user()->user_type); ?></small></a>
                                  </h4>
                                </div>
                            ...
                            <hr>
												...
												<?php if( Auth::user()->user_type == 'Sales Agent' || Auth::user()->user_type == 'Owner'): ?>
                        <div class="card">
                            <div class="header">
